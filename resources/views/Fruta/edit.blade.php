					...
					<div class="table-container">
						<form method="POST" action="{{ route('fruta.update',$fruta->id) }}"  role="form">
							...
							<div class="row">
								...
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="seccion" id="seccion" class="form-control input-sm" value="{{$fruta->seccion}}">
									</div>
								</div>
							</div>
 
							<div class="form-group">
								<textarea name="cantidad" class="form-control input-sm"  placeholder="Cantidad">{{$fruta->cantidad}}</textarea>
							</div>
